...
class VendorOrder(db.Model):
    ...
    status = db.Column(db.String(50), nullable=False, default="Pending")  # Pending | Partially Received | Received | Cancelled
    created_at = db.Column(db.DateTime, default=lambda: datetime.now(timezone.utc))
    received_at = db.Column(db.DateTime, nullable=True)

    book = db.relationship("Book", backref="vendor_orders", lazy=True)
